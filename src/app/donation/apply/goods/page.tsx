...
function GoodsDonationForm() {
    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground mb-8">
          소중한 마음에 감사드립니다. <br />
          담당자가 확인 후 물품후원 관련 안내를 위해 연락드리겠습니다.
        </p>
        <a href={ROUTES.DONATION} className="text-primary font-bold hover:underline">
          ← 후원안내 페이지로 돌아가기
        </a>
      </motion.div>
    );
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-8 text-center">물품후원 신청서</h2>
      
      <div className="space-y-6">
        <div>
          <label className="block text-sm font-bold mb-2">이름 (또는 단체명) <span className="text-rose-500">*</span></label>
          <input
            type="text"
            name="name"
            value={form.name}
        ...
        <div>
          <label className="block text-sm font-bold mb-2">후원하실 품목 및 수량 <span className="text-rose-500">*</span></label>
          <textarea
            name="message"
            value={form.message}
            onChange={handleChange}
            required
            rows={4}
            placeholder="예: 성인용 기저귀 2박스, 물티슈 5박스 등 후원하실 물품의 종류와 대략적인 수량을 적어주세요."
    ...
    <main className="min-h-screen bg-background transition-colors duration-300">
      ...
      <section className="pt-32 pb-20 bg-secondary/20">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">물품후원 신청</h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              생필품, 식료품, 의류 등 실생활에 필요한 물품을 기부하여 <br/> 따뜻한 사랑을 전합니다.
            </p>
          </motion.div>
        </div>
      </section>
