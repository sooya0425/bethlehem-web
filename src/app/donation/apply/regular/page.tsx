...
function RegularDonationForm() {
    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground mb-8">
          소중한 마음에 감사드립니다. <br />
          담당자가 확인 후 정기후원 신청 절차(CMS 등)를 위해 연락드리겠습니다.
        </p>
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-8 text-center">정기후원 신청서</h2>
      ...
      <div className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-bold mb-2">매월 정기 후원 금액</label>
          <input
            type="text"
            name="amount"
            value={form.amount}
...
export default function RegularDonationPage() {
  return (
    <main className="min-h-screen bg-background transition-colors duration-300">
      ...
      <section className="pt-32 pb-20 bg-accent/5">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6">정기후원 신청</h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              매월 일정 금액을 정기적으로 후원하여 장애인들의 안정적인 생활을 돕습니다. <br/> 꾸준한 나눔이 가장 큰 사랑입니다.
            </p>
          </motion.div>
        </div>
      </section>
